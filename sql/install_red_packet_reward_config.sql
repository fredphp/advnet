...
-- 2. 创建红包奖励配置表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `advn_red_packet_reward_config` (
...
-- ----------------------------
SELECT '======================================' AS '';
SELECT '红包奖励配置表安装完成！' AS message;
SELECT '======================================' AS '';
SELECT COUNT(*) AS '配置数据数量' FROM `advn_red_packet_reward_config`;
SELECT COUNT(*) AS '菜单数量' FROM `advn_auth_rule` WHERE name LIKE 'redpacket/rewardconfig%';
