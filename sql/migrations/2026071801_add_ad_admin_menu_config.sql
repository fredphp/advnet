...
-- 2. 子菜单：收益记录
INSERT INTO `advn_auth_rule` (`pid`, `name`, `title`, `icon`, `condition`, `remark`, `ismenu`, `createtime`, `updatetime`, `weigh`, `status`)
VALUES (@ad_menu_id, 'adincome/log', '收益记录', 'fa fa-list-alt', '', '广告收益记录管理', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 10, 'normal');
...
(@ad_log_id, 'adincome/log/index', '查看', '', '', '', 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 'normal'),
(@ad_log_id, 'adincome/log/detail', '详情', '', '', '', 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 'normal'),
(@ad_log_id, 'adincome/log/del', '删除', '', '', '', 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 'normal'),
(@ad_log_id, 'adincome/log/multi', '批量更新', '', '', '', 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 'normal');

-- 3. 子菜单：广告红包
INSERT INTO `advn_auth_rule` (`pid`, `name`, `title`, `icon`, `condition`, `remark`, `ismenu`, `createtime`, `updatetime`, `weigh`, `status`)
VALUES (@ad_menu_id, 'adincome/redpacket', '广告红包', 'fa fa-envelope', '', '广告红包管理', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 20, 'normal');

SET @ad_rp_id = LAST_INSERT_ID();

-- 广告红包 - 权限节点
INSERT INTO `advn_auth_rule` (`pid`, `name`, `title`, `icon`, `condition`, `remark`, `ismenu`, `createtime`, `updatetime`, `weigh`, `status`) VALUES
(@ad_rp_id, 'adincome/redpacket/index', '查看', '', '', '', 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 'normal'),
(@ad_rp_id, 'adincome/redpacket/detail', '详情', '', '', '', 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 'normal'),
(@ad_rp_id, 'adincome/redpacket/del', '删除', '', '', '', 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 'normal'),
(@ad_rp_id, 'adincome/redpacket/multi', '批量更新', '', '', '', 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 'normal');

-- 4. 子菜单：广告统计
INSERT INTO `advn_auth_rule` (`pid`, `name`, `title`, `icon`, `condition`, `remark`, `ismenu`, `createtime`, `updatetime`, `weigh`, `status`)
VALUES (@ad_menu_id, 'adincome/stat', '广告统计', 'fa fa-bar-chart', '', '广告收益统计分析', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 30, 'normal');
