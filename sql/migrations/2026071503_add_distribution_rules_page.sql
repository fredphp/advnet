-- =====================================================
-- 分销规则单页数据迁移
-- 在 advn_shop_page 表中插入分销规则内容（id=3）
-- 执行时间: 2026-07-15
-- =====================================================

INSERT INTO `advn_shop_page` (
  `id`, `category_id`, `admin_id`, `type`, `title`,
  `seotitle`, `keywords`, `description`, `flag`, `image`,
  `content`, `icon`, `views`, `likes`, `dislikes`,
  `diyname`, `showtpl`, `parsetpl`,
  `createtime`, `updatetime`, `deletetime`, `weigh`, `status`
) VALUES (
  3,
  0,
  0,
