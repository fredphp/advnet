define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'invite/config/index',
                    add_url: 'invite/config/add',
                    edit_url: 'invite/config/edit',
                    del_url: 'invite/config/del',
                    multi_url: 'invite/config/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'title', title: '配置名称', operate: 'LIKE'},
