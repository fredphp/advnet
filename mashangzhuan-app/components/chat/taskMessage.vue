<template>
	<view :class="['message', isMe ? 'me' : 'other']">
		...
		<view class="content-wrapper">
			...
			<!-- 聊天任务卡片 -->
			<view v-if="msgType === 'chat'" class="task-card chat-card" @click="handleCardClick">
				<view class="card-header">
					<image class="card-icon" src="/static/image/avatar.png" mode="aspectFit"></image>
				...
				<view class="card-body" v-if="message.chatContent">
					<text class="chat-text">{{ message.chatContent }}</text>
				</view>
				<view class="card-footer">
					<text class="footer-label">聊天任务</text>
					<view class="chat-duration" v-if="message.chatDuration">
						<text class="duration-text">{{ message.chatDuration }}s</text>
					</view>
				</view>
			</view>
