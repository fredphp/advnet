 ...
 * 
 * // 查询指定年份
 * $orders = WithdrawOrderSplit::useTable(strtotime('2026-01-01'))->where('user_id', 1)->select();
 * 
 * // 跨表查询统计
 * $stats = WithdrawOrderSplit::getYearStats('2026-01-01', '2026-12-31');
 */
class WithdrawOrderSplit extends SplitTableModel
{
    // 分表类型：按年
    protected $splitType = 'year';
