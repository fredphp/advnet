...
-- 1. 创建单页分类表
CREATE TABLE IF NOT EXISTS `fa_singlepage_category` (
...
-- 2. 创建单页表
CREATE TABLE IF NOT EXISTS `fa_singlepage` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
-- 4. 插入一些示例分类数据
INSERT INTO `fa_singlepage_category` (`name`, `description`, `weigh`, `status`, `createtime`, `updatetime`) VALUES
